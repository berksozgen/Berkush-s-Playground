...
{
	ConstructorHelpers::FClassFinder<UUserWidget> ServerRowBPClass(TEXT("/BerkushsMultiplayerBase/MenuSystem/WBP_ServerRow"));
...
bool UMainMenu::Initialize()
{
	...
	CustomizeButton->OnClicked.AddDynamic(this, &UMainMenu::OpenCustomizeMenu);
...
void UMainMenu::JoinServer()
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("Selected index is null"));
	}
}
...
void UMainMenu::OpenCustomizeMenu()
{
	if (!ensure(MenuSwitcher!=nullptr)) return;
	if (!ensure(CustomizeMenu!=nullptr)) return;
