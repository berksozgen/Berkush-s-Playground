...
UMultiplayerGameInstance::UMultiplayerGameInstance(const FObjectInitializer& ObjectInitializer)
{
	...
	ConstructorHelpers::FClassFinder<UUserWidget> MenuBPClass(TEXT("/BerkushsMultiplayerBase/MenuSystem/WBP_MainMenu")); //change this
	if (!ensure(MenuBPClass.Class != nullptr)) return;

	MenuClass = MenuBPClass.Class;
	
	ConstructorHelpers::FClassFinder<UUserWidget> InGameMenuBPClass(TEXT("/BerkushsMultiplayerBase/MenuSystem/WBP_InGameMenu")); //change thhis also 
